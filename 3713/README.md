...
A substring (a contiguous **non-empty** sequence of characters within a string) of `s` is called **balanced** if all **distinct** characters in the **substring** appear the **same** number of times.
