...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        TestCase[] tests = {
                new TestCase(makeTree(new Integer[] { 1, null, 2, 3 }), List.of(3, 2, 1)),
                new TestCase(makeTree(new Integer[] { 1, 2, 3, 4, 5, null, 8, null, null, 6, 7, 9 }), List.of(4, 6, 7, 5, 2, 9, 8, 3, 1)),
        ...
        for (TestCase test : tests) {
            List<Integer> actual = s.postorderTraversal(test.in);
            assert Objects.equals(test.expected, actual) : "postorderTraversal(%s) == %s, want %s".formatted(test.in,
